                                            ...
                                            <td className="px-4 py-3">
                                                <div className="flex items-center gap-3">
                                                    <div className="w-8 h-8 rounded-lg bg-slate-100 text-text-muted flex items-center justify-center text-xs font-semibold overflow-hidden border border-border">
                                                        {s.avatarUrl ? (
                                                            <img src={s.avatarUrl.startsWith('http') ? s.avatarUrl : `${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:3001'}${s.avatarUrl}`} className="w-full h-full object-cover" alt="" />
                                                        ) : s.firstName?.[0] || 'S'}
                                                    </div>
                                                    <div>
