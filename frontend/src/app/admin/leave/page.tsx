                        ...
                        <div className="space-y-3">
                            {filteredLeaves.map(leave => {
                                ...
                                const studentName = leave.student?.user
                                    ? `${leave.student.user.firstName} ${leave.student.user.lastName}` : 'ไม่ทราบ';
        ...
        <Modal isOpen={!!leave} onClose={onClose} title="พิจารณาใบลา" maxWidth="max-w-md">
            <div className="p-6 space-y-4">
                ...
                <div>
                    ...
                    <textarea value={note} onChange={e => setNote(e.target.value)} className="input-field w-full" rows={2} placeholder="เพิ่มหมายเหตุ..." />
                </div>
