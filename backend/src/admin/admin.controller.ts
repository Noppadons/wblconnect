...
import { CreateStudentDto, UpdateStudentDto, CreateTeacherDto, UpdateTeacherDto, CreateClassroomDto, UpdateClassroomDto, UpdateSettingsDto } from './dto/admin.dto';
...
export class AdminController {
    ...
    @Patch('classrooms/:id')
    async updateClassroom(@Param('id') id: string, @Body() data: UpdateClassroomDto) {
